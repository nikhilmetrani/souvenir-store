...
public class DiscountTest extends TestCase{
    ...
    private Item item;
 	...
 	private Map<String,Discount> discountMap = new HashMap<String,Discount>();
...
//10. Test Maximum discount for member when discount transaction date > start date and period in days is -ve
	    ...
	    Discount discount21 = new MemberDiscount("Discount21", "Member Discount", "ALWAYS", "ALWAYS", 30, "M");
        Discount discount22 = new Discount("Discount22", "Member Discount", "2015-05-05", "20", 30, "M");
        Discount discount23 = new Discount("Discount23", "Member Discount", "2015-01-05", "240", 20.5, "M");
        Discount discount24 = new Discount("Discount24", "Member Discount", "2014-01-05", "240", 20.5, "M");
        Discount discount25 = new Discount("Discount25", "Member Discount", "ALWAYS", "20", 20.5, "M");
        discountMap.put("discount21",discount21);
        discountMap.put("discount22",discount22);
        discountMap.put("discount23",discount23);
        discountMap.put("discount24",discount24);
        discountMap.put("discount25",discount25);
    }
	...
	public void testTotalPriceAfterDiscountForPublic() {
		...
		@Test
		public void testValidityOfTheDiscountForMember() {
			try{
				String transDate = "2015-04-03"; 
				//new MemberDiscount("Discount21", "Member Discount", "ALWAYS", "20", 30, "M");
				Discount discount = discountMap.get("discount21"); 
				isValid = discount.isValid(discount, transDate);
				assertTrue(isValid);
				
				discount = discountMap.get("discount22"); 
				isValid = discount.isValid(discount, transDate);
				assertFalse(isValid);
				
				discount = discountMap.get("discount23"); 
				isValid = discount.isValid(discount, transDate);
				assertTrue(isValid);
				
				discount = discountMap.get("discount24"); 
				isValid = discount.isValid(discount, transDate);
				assertFalse(isValid);
